import { StyleSheet, Text, View, ScrollView, Image, StatusBar, TouchableOpacity, Modal, TextInput } from 'react-native'
...
const BookingInformation = ({route}) => {
    ...
    useEffect(() => {
        ...
        setIsToday(dayjs(new Date()).dayOfYear() === dayjs(bookingItem.serviceDate).dayOfYear())
    ...
    return (
        <ScrollView contentContainerStyle={styles.mainContainer}>
            ...
            {
                bookingInformation.bookingStatus == '2' || global.userData.role === "worker" && !bookingCanceled ?
                    <TouchableOpacity style={[styles.statusUpdaterBtn, {backgroundColor: twoBookingStatus || bookingInformation.bookingStatus == '2' ? ThemeDefaults.themeLighterBlue : ThemeDefaults.themeOrange}]}
                        activeOpacity={0.6}
                        onPress={()=> {
                    ...
                    >
                        <TText style={[styles.statusUpdaterText,]}>{bookingInformation.bookingStatus == '2' ? "Show OTP" : global.userData.role === 'recruiter' ? null : "On My Way!"}</TText>
                        ...
                        <View style={styles.waitCancel}>
                            {
                                ...
                                :
                                <TText style={styles.waitCancelText}>Wait for the scheduled time or </TText>
                            }
                ...
                <View style={styles.messageToOtherCancellationContainer}>
                    ...
                    <View style={styles.messageContainer}>
                        ...
                        <View style={styles.messageBoxContainer}>
                            <TText style={styles.messageText}>Sorry, kailangan ko pumunta ng hospital</TText>
                        </View>
                    </View>
                </View>
            }
            ...
            >
                ...
                <View style={styles.modalDialogue}>
                    ...
                    <View style={styles.dialogueContainer}>
                        {/* Modal Message/Notice */}
                        <View style={styles.dialogueMessage}>
                            <TText style={[styles.dialogueMessageText, {marginBottom: 15}]}>Today is not the scheduled date.</TText>
                            <TText style={[styles.dialogueMessageText,]}>Do you still want to continue?</TText>
                        </View>
                        {/* Modal Buttons */}
                        <View style={styles.modalDialogueBtnCont}>
                            <TouchableOpacity
                ...
                <View style={styles.modalDialogue}>
                    ...
                    <View style={styles.dialogueContainer}>
                        {/* Modal Message/Notice */}
                        {
                            ...
                            <>
                                <View style={styles.dialogueMessage}>
                                    <TText style={[styles.dialogueMessageText, {fontSize: 18, marginBottom: 5}]}>Compare OTP to Worker</TText>
                                    <TText style={[styles.dialogueMessageText, {fontSize: 14, marginBottom: 20, color: '#f0f0f0'}]}>The recruiter should confirm the OTP to start the service</TText>
                                    <TText style={[styles.dialogueMessageText,{fontSize: 25}]}>{bookingItem.otp}</TText>
                                </View>
                                {/* Modal Buttons */}
                                <View style={styles.modalDialogueBtnCont}>
                                    <TouchableOpacity
                            ...
                            <>
                                <View style={styles.dialogueMessage}>
                                    <TText style={[styles.dialogueMessageText, {fontSize: 18, marginBottom: 5}]}>Compare OTP to Recruiter</TText>
                                    <TText style={[styles.dialogueMessageText, {fontSize: 14, marginBottom: 20, color: '#f0f0f0'}]}>The Recruiter should confirm the OTP and the service should automatically start</TText>
                                    <TText style={[styles.dialogueMessageText,{fontSize: 25}]}>{bookingItem.otp}</TText>
                                </View>
                                {/* Modal Buttons */}
                                <View style={styles.modalDialogueBtnCont}>
